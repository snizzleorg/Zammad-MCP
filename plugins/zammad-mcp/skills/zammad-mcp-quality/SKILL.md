...
Codex: Let me help you with pre-PR review using the Zammad MCP Quality skill.
...
Codex: I'll implement following Zammad MCP patterns from the quality skill.
...
Codex: Let me check the pagination-patterns.md guide...
...
**CLAUDE.md** - Repository agent guidance
