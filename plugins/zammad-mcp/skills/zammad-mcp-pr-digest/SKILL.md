...
```bash
python3 plugins/zammad-mcp/skills/zammad-mcp-pr-digest/scripts/collect_pr_digest.py --window 30d
```

Run targeted PR triage:

```bash
python3 plugins/zammad-mcp/skills/zammad-mcp-pr-digest/scripts/triage_pr.py --pr 200 --dry-run --json
```

Run open PR backfill:

```bash
python3 plugins/zammad-mcp/skills/zammad-mcp-pr-digest/scripts/triage_pr.py --backfill --state open --dry-run --json
```
...
```bash
uv run pytest plugins/zammad-mcp/skills/zammad-mcp-pr-digest/scripts/test_triage_pr.py
```

```bash
python3 plugins/zammad-mcp/skills/zammad-mcp-pr-digest/scripts/collect_pr_digest.py --window 30d --limit-prs 50
```
